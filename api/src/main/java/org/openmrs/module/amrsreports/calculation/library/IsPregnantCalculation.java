...
public class IsPregnantCalculation extends BaseEmrCalculation implements PatientFlagCalculation {
    ...
    public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> parameterValues, PatientCalculationContext context) {
		...
		Concept yes = getConcept("5454"/*Dictionary.YES*/);
		CalculationResultMap pregStatusObss = Calculations.lastObs(getConcept("65656"/*Dictionary.PREGNANCY_STATUS*/), alive, context);
