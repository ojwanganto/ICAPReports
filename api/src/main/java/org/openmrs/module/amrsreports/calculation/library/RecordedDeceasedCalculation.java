...
public class RecordedDeceasedCalculation extends BaseEmrCalculation {
	...
	public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> params, PatientCalculationContext context) {
		...
		CalculationResultMap exitObss = Calculations.allObs(new Concept(12)/*Dictionary.getConcept(Dictionary.REASON_FOR_PROGRAM_DISCONTINUATION)*/, alive, context);
		Concept died = new Concept(10)/*Dictionary.getConcept(Dictionary.DIED)*/;
