...
public class MissedAppointmentsOrDefaultedCalculation extends BaseEmrCalculation implements PatientFlagCalculation {
    ...
    public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> parameterValues, PatientCalculationContext context) {
        ...
        CalculationResultMap lastReturnDateObss = Calculations.lastObs(getConcept(MohEvaluableNameConstants.ADMITTED_TO_HOSPITAL/*Dictionary.RETURN_VISIT_DATE*/), inHivProgram, context);
