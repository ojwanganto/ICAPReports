...
public class PregnantAtArtStartCalculation extends BaseEmrCalculation {
	...
	public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> parameterValues, PatientCalculationContext context) {
		...
		Concept yes = MohCacheUtils.getConcept(MohEvaluableNameConstants.YES);
		Concept pregnancyStatus = MohCacheUtils.getConcept(MohEvaluableNameConstants.ADMITTED_TO_HOSPITAL/*Dictionary.PREGNANCY_STATUS*/);
