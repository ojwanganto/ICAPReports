...
public class ArtIndicatorLibrary {
	...
	public CohortIndicator enrolledExcludingTransfers() {
		return commonIndicators.enrolledExcludingTransfers(MetadataUtils.getProgram(MohEvaluableNameConstants.ADMITTED_TO_HOSPITAL/*Metadata.Program.HIV*/));
	}
	...
	public CohortIndicator enrolledCumulative() {
		return commonIndicators.enrolledCumulative(MetadataUtils.getProgram(MohEvaluableNameConstants.ALL/*Metadata.Program.HIV*/));
	}
	...
	public CohortIndicator onCotrimoxazoleProphylaxis() {
		Concept[] drugs = { MohCacheUtils.getConcept(MohEvaluableNameConstants.ADMITTED_TO_HOSPITAL/*.SULFAMETHOXAZOLE_TRIMETHOPRIM*/) };
	...
	public CohortIndicator onFluconazoleProphylaxis() {
        ...
        Concept[] drugs = { MohCacheUtils.getConcept(MohEvaluableNameConstants.FLUCONAZOLE) };
	...
	public CohortIndicator onProphylaxis() {
		Concept[] drugs = { MohCacheUtils.getConcept(MohEvaluableNameConstants.FLUCONAZOLE), MohCacheUtils.getConcept(MohEvaluableNameConstants.AMPHOTERICIN_B/*.SULFAMETHOXAZOLE_TRIMETHOPRIM*/) };
