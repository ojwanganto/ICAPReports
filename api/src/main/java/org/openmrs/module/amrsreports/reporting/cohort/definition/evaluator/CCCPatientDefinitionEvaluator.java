 ...
 */
@Handler(supports = {CCCPatientCohortDefinition.class})
public class CCCPatientDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
        ...
        CCCPatientCohortDefinition definition = (CCCPatientCohortDefinition) cohortDefinition;
