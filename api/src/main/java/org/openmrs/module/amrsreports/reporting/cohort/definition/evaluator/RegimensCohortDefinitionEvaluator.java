 ...
 */
@Handler(supports = {RegimensCohortDefinition.class})
public class RegimensCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
        ...
        RegimensCohortDefinition definition = (RegimensCohortDefinition) cohortDefinition;
