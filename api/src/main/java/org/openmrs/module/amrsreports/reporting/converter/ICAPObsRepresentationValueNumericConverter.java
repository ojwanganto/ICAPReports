 ...
 */
public class ICAPObsRepresentationValueNumericConverter implements DataConverter {
	...
	public ICAPObsRepresentationValueNumericConverter() {
		// pass
	}

	public ICAPObsRepresentationValueNumericConverter(Integer precision) {
	...
	public Object convert(Object original) {
        ...
        Set<ObsRepresentation> oo = (Set<ObsRepresentation>) original;
        ArrayList<ObsRepresentation> al = new ArrayList<ObsRepresentation>(oo);
		ObsRepresentation o = al.get(0);
