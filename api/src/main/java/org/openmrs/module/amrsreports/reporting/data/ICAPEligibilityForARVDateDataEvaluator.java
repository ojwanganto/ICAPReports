...
import org.openmrs.module.amrsreports.reporting.data.evaluator.DrugStartStopDataEvaluator;
 ...
 */
@Handler(supports = ICAPEligibilityForARVDateDataDefinition.class, order = 50)
public class ICAPEligibilityForARVDateDataEvaluator extends DrugStartStopDataEvaluator {
