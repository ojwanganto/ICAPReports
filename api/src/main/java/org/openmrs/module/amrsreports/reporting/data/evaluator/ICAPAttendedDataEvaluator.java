...
import org.openmrs.module.amrsreports.reporting.data.ICAPAttendedDataDefinition;
 ...
 */
@Handler(supports = ICAPAttendedDataDefinition.class, order = 50)
public class ICAPAttendedDataEvaluator implements PersonDataEvaluator {
