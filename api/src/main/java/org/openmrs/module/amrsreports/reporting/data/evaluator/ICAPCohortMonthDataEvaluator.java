...
import org.openmrs.module.amrsreports.reporting.data.ICAPCohortMonthDataDefinition;
 ...
 */
@Handler(supports = ICAPCohortMonthDataDefinition.class, order = 50)
public class ICAPCohortMonthDataEvaluator implements PersonDataEvaluator {
