...
/**
 */
@Handler(supports = ICAPCtxStartStopDataDefinition.class, order = 50)
public class ICAPCtxStartStopDataEvaluator extends DrugStartStopDataEvaluator {
	...
	public EvaluatedPersonData evaluate(final PersonDataDefinition definition, final EvaluationContext context) throws EvaluationException {
		...
		String sql = "select person_id, obs_datetime" +
                ...
                "    and concept_id = 162229 and value_coded=1065  " +
				"    and voided = 0 ";
