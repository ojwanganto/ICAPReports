 ...
 */
@Handler(supports = ICAPLTFUTODeadDataDefinition.class, order = 50)
public class ICAPLTFUTODeadDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
		...
		String obsDeathSQL = "select person_id, obs_datetime" +
				"	from obs" +
				"	where" +
				"		voided=0" +
