...
import org.openmrs.module.amrsreports.reporting.data.ICAPLandMarkDataDefinition;
 ...
 */
@Handler(supports = ICAPLandMarkDataDefinition.class, order = 50)
public class ICAPLandMarkDataEvaluator implements PersonDataEvaluator {
