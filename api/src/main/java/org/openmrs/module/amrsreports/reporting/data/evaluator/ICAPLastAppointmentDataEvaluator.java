 ...
 */
@Handler(supports = ICAPLastAppointmentDataDefinition.class, order = 50)
public class ICAPLastAppointmentDataEvaluator extends DrugStartStopDataEvaluator {
	...
	public EvaluatedPersonData evaluate(final PersonDataDefinition definition, final EvaluationContext context) throws EvaluationException {
		...
		String hql = "select personId, max(valueDatetime) " +
				"	from Obs" +
				" 	where voided = false" +
