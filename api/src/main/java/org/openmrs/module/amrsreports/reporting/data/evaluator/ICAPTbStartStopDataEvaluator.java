...
/**
 */
@Handler(supports = ICAPTbStartStopDataDefinition.class, order = 50)
public class ICAPTbStartStopDataEvaluator extends DrugStartStopDataEvaluator {
	...
	public EvaluatedPersonData evaluate(final PersonDataDefinition definition, final EvaluationContext context) throws EvaluationException {
		...
		String sql = "select person_id, value_datetime" +
				" 	from obs" +
				" 	where" +
				"		person_id in (:personIds)" +
				"   	and concept_id=1659 and value_coded =1662 " +
				"   	and value_datetime is not null" +
				"		and voided = 0";

		ListMap<Integer, Date> mappedStartDates = makeDatesMapFromSQL(sql, m);

		sql = "select person_id, value_datetime" +
				" 	from obs" +
				" 	where" +
				"		person_id in (:personIds)" +
				"   	and concept_id=1659 and value_coded =1663 " +
				"   	and value_datetime is not null" +
				"		and voided = 0";
