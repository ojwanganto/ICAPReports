 ...
 */
public class ICAPMOH361BReportProvider extends ReportProvider {
	...
	public ICAPMOH361BReportProvider() {
		this.name = "MOH 361B";
		this.visible = true;
	...
	public ReportDefinition getReportDefinition() {
        ...
        ICAPObsNearestARVStartDateDataDefinition whoDef = new ICAPObsNearestARVStartDateDataDefinition(
                "WHO closest to ARV start",
                Context.getConceptService().getConcept(5356)
        );
        dsd.addColumn("WHO Stage at ART Start", whoDef, nullString, new ICAPFirstWHOStageConverter());

        // j. CD4 at start of ARVs
       ICAPObsNearestARVStartDateDataDefinition cd4Def = new ICAPObsNearestARVStartDateDataDefinition(
        ...
        // m. CTX start date
        dsd.addColumn("CTX Start Dates", new ICAPCtxStartStopDataDefinition(), nullString/*, new DateListCustomConverter(MONTH_AND_YEAR_FORMAT)*/);

        // n. INH Start
        dsd.addColumn("INH Start Dates", new ICAPTbStartStopDataDefinition(), nullString/*, new DateListCustomConverter(MONTH_AND_YEAR_FORMAT)*/);

        // o. TB Treatment Start Month / Year
        dsd.addColumn("TB Treatment Start Dates", new ICAPTbStartStopDataDefinition(), nullString/*, new TbTreatmentStartDateConverter()*/);

        //aa. month zero
        dsd.addColumn("Month 0", new ICAPDateARTStartedDataDefinition(), nullString, new ARTMonthZeroConverter());

        // k. Height at start of ARVs
      /*  ICAPObsNearestARVStartDateDataDefinition heightDef = new ICAPObsNearestARVStartDateDataDefinition(
        ...
        ICAPObsNearestARVStartDateDataDefinition weightDef = new ICAPObsNearestARVStartDateDataDefinition(
