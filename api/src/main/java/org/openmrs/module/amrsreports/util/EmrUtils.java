...
public class EmrUtils {
	...
	public static Form getVisitSourceForm(Visit visit) {
		VisitAttributeType sourceAttrType = MetadataUtils.getVisitAttributeType(MohEvaluableNameConstants.ADMITTED_TO_HOSPITAL/*Metadata.VisitAttributeType.SOURCE_FORM*/);
	...
	public static Integer whoStage(Concept c) {
		if (c != null) {
			if (c.equals(MohCacheUtils.getConcept(MohEvaluableNameConstants.WHO_STAGE_1_ADULT)) || c.equals(MohCacheUtils.getConcept(MohEvaluableNameConstants.WHO_STAGE_1_PEDS))) {
				return 1;
			}
			if (c.equals(MohCacheUtils.getConcept(MohEvaluableNameConstants.WHO_STAGE_2_ADULT)) || c.equals(MohCacheUtils.getConcept(MohEvaluableNameConstants.WHO_STAGE_2_PEDS))) {
				return 2;
			}
			if (c.equals(MohCacheUtils.getConcept(MohEvaluableNameConstants.WHO_STAGE_3_ADULT)) || c.equals(MohCacheUtils.getConcept(MohEvaluableNameConstants.WHO_STAGE_3_PEDS))) {
				return 3;
			}
			if (c.equals(MohCacheUtils.getConcept(MohEvaluableNameConstants.WHO_STAGE_4_ADULT)) || c.equals(MohCacheUtils.getConcept(MohEvaluableNameConstants.WHO_STAGE_4_PEDS))) {
				return 4;
			}
		}
		return null;
